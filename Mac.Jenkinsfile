pipeline {
    ...
    environment {
        ...
        XCALBUILD_NEXUS_REPO_ADDRESS_SH="${XCALBUILD_NEXUS_REPO_ADDRESS_SH ? XCALBUILD_NEXUS_REPO_ADDRESS_SH : 'http://127.0.0.1:8081/repository/xcalbuild-mac/'}"
        XCALBUILD_NEXUS_REPO_ADDRESS_SZ="${XCALBUILD_NEXUS_REPO_ADDRESS_SZ ? XCALBUILD_NEXUS_REPO_ADDRESS_SZ : 'http://127.0.0.1:8081/repository/xcalbuild-mac/'}"
    }
